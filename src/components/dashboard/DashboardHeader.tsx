...
const Search = () => {
    return (
        <div className='flex-1 flex justify-center'>
            <div className='bg-[#f2f3f3] text-[#7e7f7e] py-1.5 px-2 flex items-center gap-2 rounded w-1/2 text-sm'>
                <CiSearch size={20} />
                <input
                    className='outline-none bg-[#f2f3f3] flex-1'
...
const DashboardHeader = () => {
    return (
        <div className='w-full h-[54px] shadow-sm flex items-center gap-4 py-1.5 px-6 bg-white'>
